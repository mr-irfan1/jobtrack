...
/**
 * Inline SVG icon set for the app shell and dashboard. Hand-written so the app
 * takes on no icon dependency: each icon is a stroke glyph on a 24x24 grid that
 * inherits the current text color, so callers size and color it with utility
 * classes (e.g. `className="h-5 w-5"`). Icons are decorative by default
 * (aria-hidden); when an icon is a control's only content, the control supplies
 * its own aria-label.
 */
...
/** Double chevron pointing left; rotate 180° to indicate "expand" when collapsed. */
...
export function BriefcaseIcon(props: IconProps) {
  return (
    <Icon {...props}>
      ...
      <path d="M8.25 7.5V6A2.25 2.25 0 0 1 10.5 3.75h3A2.25 2.25 0 0 1 15.75 6v1.5M3 12.75h18" />
    </Icon>
  )
}
...
/** Checkmark — used for the JobTrack brand mark and the "done" step state. */
...
/** Open eye — "password is visible", toggles to EyeOffIcon. */
...
/** Eye with a slash — "password is hidden", toggles to EyeIcon. */
...
/** Sun — shown by the theme toggle in light mode. */
...
/** Crescent moon — shown by the theme toggle in dark mode. */
...
/** Bell — the notifications control in the navbar. */
...
export function PipelineIcon(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M3 7.5h18M6 12h12M9 16.5h6" />
    </Icon>
  )
}
...
/** Google G logo icon for social login buttons. */
...
/** GitHub Octocat logo icon for social login buttons. */
...
export function ClockArrowIcon(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M12 6v6l4 2" />
...
/** Crosshair / target — used for Job Match. */
...
/** Lightning bolt — used for ATS Analysis / speed. */
...
/** Shield check — used for security / verification contexts. */
...
/** Chat bubble — used for Interview Prep / conversation. */
...
/** Compass — used for Job Discovery / navigation. */
export function CompassIcon(props: IconProps) {
  return (
    <Icon {...props}>
      <circle cx="12" cy="12" r="9" />
      <path d="m14.828 9.172-1.414 5.657-5.657 1.414 1.414-5.657 5.657-1.414Z" />
    </Icon>
  )
}

/** Bell with alert dot — used for Job Alerts / notifications. */
...
export function InfoIcon(props: IconProps) {
  return (
    <Icon {...props}>
      <circle cx="12" cy="12" r="9" />
      <path d="M12 8.25v.01M12 11.25v4.5" />
    </Icon>
  )
}
